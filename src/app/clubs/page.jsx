    ...
    <>
      <div className=" mx-4 md:mx-44">
        ...
        <div className=" grid md:grid-cols-3 gap-10">
          <div className="relative bg-white text-center p-4 rounded-md shadow-md">
            {/* Notification */}
            <div className="absolute top-0 right-0 bg-red-500 text-white px-2  rounded-full">
              1
            </div>
            ...
            <Link href="/pasc">
              <button className="bg-[#155EB3] text-white p-2 px-6 rounded-md font-bold my-2 text-sm">
                View
              </button>
            </Link>
          </div>
