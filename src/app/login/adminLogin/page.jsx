  ...
  return (
    ...
    <div className='   p-4     mx-10  rounded-sm py-8 md:py-0  md:mt-5 '>
        <div className=' text-center'>
            <p className=' text-[#155EB3]  font-extrabold  text-4xl my-2'>Admin Login</p>
            ...
            <button className=' text-white bg-[#155EB3] p-1 px-4 rounded my-3 font-bold px-6' onClick={()=>handleSubmit("admin")}>Login</button>
        </div>
    </div>
    </>
  )
